...
- **Rotozoomer Overlay**: A smaller, floating texture (checkered logo) spinning and scaling smoothly across the screen, rendered directly into the pixel buffer on top of the 3D floor with 50% translucency.
